...
if '.short-answer-input' not in c:
    c += '''\n.short-answer-wrap{display:flex;flex-direction:column;gap:9px}.short-answer-input{width:100%;border:2px solid #cbd5e1;border-radius:14px;padding:14px 16px;font-size:1rem;background:#fff;color:#0f172a;outline:none;transition:.18s}.short-answer-input:focus{border-color:#0891b2;box-shadow:0 0 0 3px rgba(8,145,178,.12)}.short-answer-input.correct{border-color:#16a34a;background:#f0fdf4}.short-answer-input.wrong{border-color:#dc2626;background:#fef2f2}\n'''
    css.write_text(c)

print('strict short-answer autocorrection applied: exact spelling required; outer spaces ignored; correct answer remains hidden after submission')
