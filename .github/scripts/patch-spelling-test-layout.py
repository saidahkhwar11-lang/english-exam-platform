...
# Detect spelling tests by their exam name or the uploaded document headings.
...
# Spelling scoring rules:
# Part 1: exact letters in exact numbered position, case-insensitive.
# Part 2: correct expected vocabulary for that gap, allowing one slight typo.
...
# Top bar should describe the full spelling test rather than one active question.
...
# Preserve the normal exam UI exactly as-is and switch only spelling tests to a
...
print('spelling-test mode applied: one page, Part 1 left, Part 2 right, dedicated marking rules')
